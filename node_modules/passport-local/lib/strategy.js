...
function Strategy(options, verify) {
  ...
  this._nicknameField = options.nicknameField || "nickname";
...
Strategy.prototype.authenticate = function(req, options) {
  ...
  var nickname = lookup(req.body, this._nicknameField) || lookup(req.query, this._nicknameField);
  ...
  try {
    if (self._passReqToCallback) {
      this._verify(req, username, password, surname, lastname, nickname, verified);
    } else {
